  ...
  <body>
  	<div class="container">
	  	...
	  	<div class="page-header">
	  		<h1>${host.buss}的基本信息 <small>IP:${param.ip}</small></h1>
		</div>
    	<div class="row">   
    		<div class="col-sm-12">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td>CPU个数:${host.detail.CPUNumber}</td>
                   <td>
                   CPU主频:${host.detail.CPUClockSpeed }</td>
                    <td>
                    CPU核数:${host.detail.logicalCPUNumber }</td>
                </tr>
              </tbody>
            </table><!-- 内存等表格 -->
    				</div>
			 ...
			 <div class="row">
					     ...
					     <table class="table table-bordered table-hover">
					      <thead>
					              ...
					              <tbody>
					               ...
					               <%-- 由scriptlet改为jstl --%>
					              <c:forEach var="card" items="${host.detail.cardList }" varStatus="loopIndex">
					                <tr>
					     ...
					     <div class="col-sm-6">
					     	 <table class="table table-bordered table-hover">
					              ...
					              <c:forEach var="fileSystem" items="${host.detail.fsList }" varStatus="loopIndex">
					                <tr>
					                <td>${loopIndex.count }</td>
	...
	<c:forEach var="db" items="${host.dList }" varStatus="loop1">
     <div class="row">
     	<div class="col-sm-12">
     		<h2 class="text-center"><%-- ${db.type} --%>数据库的基本信息</h2>
     		<div class="row">
     			<div class="col-sm-12">
			 	...
			 	<table class="table  table-striped table-hover">
	      			...
	      			<tr><td colspan="4">数据库部署路径:${db.deploymentDir }</td></tr>
	              </tbody>
	              </table>
	             </div> 
             </div> <!-- 数据库 版本等信息行结束 -->
             	...
             	<div class="col-sm-8">
             		...
             		<thead>
	      			...
	      			<tbody>
	      				...
	      				<c:forEach var="dataFile" items="${db.dfList }" varStatus="loop2">
			      			<tr>
				      			 <td>${loop2.count }</td>
